...
model.fit_generator(myGene,steps_per_epoch=150,epochs=10,callbacks=[model_checkpoint])

testGene = testGenerator("data/membrane/test",num_image=20,as_gray = False)
